<template>
    <div class="viewMedicalData ocultar">
        <p class="description-MedicalData">
            Selecciona alguna de las siguientes opciones para poder ver los
            datos
        </p>
        ...
        <div class="data-view-list">
            <div class="view-item" v-for="item in Medicinas" :key="item.id">
                <div class="text-item">
                    ...
                    <p class="text-item-style" v-else>
    ...
    <div class="addVacunaContainer" v-if="this.isAddVacunaPopupOpen">
        <div class="addVacunaContent">
            ...
            <div style="margin-top: 2rem">
                ...
                >
                    <p class="addVacunaTitle">
                        Selecciona una vacuna para agregarla
                    </p>
                </div>
                <div style="margin-top: 1rem">
                    <label class="addVacunaLabel">Vacunas</label>
                    <select
                        class="addVacunaSelect"
                ...
                <div class="addAllergyButtonsContainer">
                    <button
                        ...
                        @click="agregarMedicina(medicinaSeleccionado, 'vacuna')"
                    >
                        Guardar
                    </button>
                    <button
    ...
    <div class="addMedicamentoContainer" v-if="this.isAddMedicamentoPopupOpen">
        <div class="addMedicamentoContent">
            ...
            <div style="margin-top: 2rem">
                ...
                <div style="margin-top: 1rem">
                    <p class="addMedicamentoLabel">
                        Diagnostico actuales del bebé:
                    </p>
                    <select
                ...
                <div style="margin-top: 1rem">
                    <p class="addMedicamentoLabel">
                        Medicamentos para el diagnostico:
                    </p>
                    <select
                        class="addMedicamentoSelect"
                        v-model="medicinaSeleccionado"
                    >
                        <option
                            v-for="medicamentoDiagnostico in this
...
export default {
    ...
    methods: {
                ...
                axios
                    ...
                    .then((response) => {
                        if (response.data.resultado) {
                            ...
                            this.message =
                                "¡Ha ocurrido al eliminar el medicamento!";
                ...
                axios
                    ...
                    .then((response) => {
                        ...
                        if (response.data.resultado) {
                            ...
                            this.message =
                                "¡Ha ocurrido al eliminar la alergia!";
                            this.alertType = "error";
                            this.showAlert();
                        }
                    })
        ...
        obternerDiagnosticosBebe() {
            ...
            const url =
                "http://localhost:3000/obtener-diagnosticos-bebe/" +
                this.idbebe;
            axios
                .get(url)
                .then((response) => {
        ...
        obternerMedicamentosDiagnostico() {
            ...
            const url =
                "http://localhost:3000/obtener-diagnosticos-medicamentos/" +
            ...
            axios
                ...
                .then((response) => {
                    if (response.data.resultado) {
                        ...
                        this.message =
                            "¡Ha ocurrido al insertar el padecimiento!";
                        this.alertType = "error";
                        this.showAlert();
                    }
                })
