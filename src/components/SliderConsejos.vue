<template>
  <div class="sliderContainer">
    ...
    <transition :name="getTransitionName()" mode="out-in">
      <div class="sliderItem" :key="currentIndex" v-if="consejos.length > 0">
        ...
        <div class="sliderContent">
          <p class="sliderTitle">{{ consejos[currentIndex].titulo }}</p>
          <p class="sliderText">{{ consejos[currentIndex].detalle }}</p>
        </div>
      </div>
    </transition>
