        ...
        <form @submit.prevent="actualizarDatos" class="login form-register">
            ...
            <div class="input-container ic1">
                <input
                    ...
                    class="input input-expediente"
                    :disabled="!activarForm"
                    type="text"
                    placeholder=""
                />
                <div class="cut"></div>
            ...
            <div class="flex flex-register input-container">
                <div class="input-container ic1">
                    ...
                    />
                    <div class="cut"></div>
                    <label class="placeholder-expediente"
                        >Peso del bebé <sub>(Kg)</sub>
                    </label>
                </div>
                <div class="input-container ic1">
                    <input
                        v-model="DatosBebe.Altura"
                        max="10"
                        class="input input-expediente"
                        :disabled="!activarForm"
                        type="text"
                    ...
                    <div class="cut"></div>
                    <label class="placeholder-expediente"
                        >Altura del bebé <sub>(cm)</sub></label
                    >
                </div>
            </div>
            ...
            <div class="input-container ic1">
                ...
                />
                <div class="cut"></div>
                <label for="firstname" class="placeholder-expediente"
                    >Género del bebe</label
                >
            </div>
            <div class="input-container">
                <input
                    v-model="DatosBebe.FechaNacimiento"
                    class="input"
                    disabled
                    type="text"
                    placeholder=""
            ...
            <div class="input-container text-center">
                <button
                    @click="registerBabyForm"
                    v-text="btn"
                    class="submit submit-register pink-background"
                ></button>
            </div>
        </form>
    </div>
        ...
        obtenerExpediente(id) {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    const mes = String(fechaObjeto.getMonth() + 1).padStart(
                        2,
                        "0"
                    );
