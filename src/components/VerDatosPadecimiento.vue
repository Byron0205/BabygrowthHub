    ...
    <div class="addAllergyContainer" v-if="this.isAddAllergyPopupOpen">
        <div class="addAllergyContent">
            ...
            <div style="margin-top: 2rem">
                ...
                >
                    <p class="addAllergyTitle">
                        Selecciona una alergia para agregarla
                    </p>
                </div>
                <div style="margin-top: 1rem">
                    <select
                        class="addAllergySelect"
                ...
                <div style="margin-top: 1rem">
                    ...
                    <div
                        ...
                        "
                    >
                        <label class="addAllergyLabel" for="fechaFin"
                            >Fecha final</label
                        >
                        <input
                            class="addAllergyInputFecha"
                ...
                axios
                    ...
                    .then((response) => {
                        if (response.data.resultado) {
                            ...
                            this.message =
                                "¡Ha ocurrido al eliminar la diagnostico!";
        ...
        obtenerDiagnosticos(id) {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.Padecimientos = this.Diagnosticos.map(
                        (diagnostico) => ({
                            ...diagnostico,
                            type: "diagnostico",
                        })
