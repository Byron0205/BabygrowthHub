<template>
    <div class="container-register">
        ...
        <form
            @submit.prevent="registerFormEncargado"
    ...
    methods: {
        ...
        validarCedula() {
            if (!this.validCedula) {
                ...
                this.encargado.IDAdulto = this.encargado.IDAdulto.replace(
                    /[^\d]/g,
                    ""
                );
            }
        ...
        validarNombre() {
            if (!this.validName) {
                ...
                this.encargado.Nombre = this.encargado.Nombre.replace(
                    /[^A-Za-z]/g,
                    ""
                );
            }
        ...
        vincularBebe() {
            ...
            axios
                ...
                .catch((error) => {
                    console.error(
                        "Error al vincular el adulto con el bebé: ",
                        error
                    );
                });
        },
