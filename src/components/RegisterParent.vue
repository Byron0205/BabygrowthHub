  ...
  <div class="container-register">
    ...
    <form @submit.prevent="registerParentForm" class="login form-register">
      <div class="input-container width-50">
        <input title="formato: 000000000" @input="validarCedula" @blur="obtenerDataUser" maxlength="9"
          v-model="parent.IDAdulto" class="input" type="text" placeholder="" />
        <div class="cut"></div>
      ...
      <div class="flex flex-register input-container width-50">
        ...
        <!-- select -->
        <div class="input-container width-50 ic1">
          <select v-model="parent.IDRol" name="relacion" :disabled="blockRol" class="input" id="">
      ...
      <div class="input-container width-50 ic1">
        <input v-model="parent.Apellidos" @input="validarApellidos" :disabled="blockApellidos" maxlength="25" class="input" type="text"
          placeholder="" />
        <div class="cut"></div>
        <label class="placeholder">Apellidos</label>
      </div>
      <div class="input-container width-50">
        <input v-model="parent.Correo" maxlength="50" class="input" type="text" placeholder="" />
        <div class="cut"></div>
        <label class="placeholder">Correo</label>
      </div>
      <div class="input-container width-50">
        <input v-model="parent.Contrasenna" maxlength="50" class="input" type="text" placeholder="" />
        <div class="cut"></div>
...
export default {
  ...
  methods: {
    ...
    async obtenerDataUser() {
      ...
      this.parent.Apellidos = data.last_name
      this.parent.IDRol = (data.Sexo == 'F') ? '1' : '2'
      this.blockRol = true
