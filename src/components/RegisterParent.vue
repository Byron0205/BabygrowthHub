    ...
    <div class="container-register">
        ...
        <form @submit.prevent="registerParentForm" class="login form-register">
            <div class="input-container width-50">
                <input
                    title="formato: 000000000"
                    @input="validarCedula"
                    @blur="obtenerDataUser"
                    maxlength="9"
                    v-model="parent.IDAdulto"
                    class="input"
                    type="text"
                    placeholder=""
                />
            ...
            <div class="flex input-container width-50">
                <div class="input-container width-50 ic1">
                    <input
                        v-model="parent.Nombre"
                        @input="validarNombre"
                        maxlength="15"
                        :disabled="blockNombre"
                        class="input"
                        type="text"
                        placeholder=""
                    />
            ...
            <div class="input-container width-50 ic1">
                <input
                    v-model="parent.Apellidos"
                    @input="validarApellidos"
                    :disabled="blockApellidos"
                    maxlength="25"
                    class="input"
                    type="text"
                    placeholder=""
...
export default {
    ...
    methods: {
        ...
        validarCampos() {
            ...
            const total = Object.values(this.parent).every(
                (value) => value !== ""
            );
        ...
        validarCedula() {
            if (!this.validCedula) {
                ...
                this.parent.IDAdulto = this.parent.IDAdulto.replace(
                    /[^\d]/g,
                    ""
                );
            }
        ...
        validarNombre() {
            if (!this.validName) {
                ...
                this.parent.Nombre = this.parent.Nombre.replace(
                    /[^A-Za-z]/g,
                    ""
                );
            }
        ...
        validarApellidos() {
            ...
            this.parent.Apellidos = this.parent.Apellidos.replace(
                /[^A-Za-z\s]/g,
                ""
            );
        },
