        ...
        <form @submit.prevent="registrarBebe" class="login form-register">
            ...
            <div class="input-container width-50">
                <p class="baby-age-msg">
                    ¿Nos podrías indicar si tu pequeño/a ya ha nacido o aún está
                    en camino?
                </p>
            </div>
            ...
            <div
                v-if="selectedAgeStatus == 'born'"
                class="input-container width-50"
            >
    ...
    methods: {
        ...
        validarNombre() {
            if (!this.validName) {
                ...
                this.DatosBebe.Nombre = this.DatosBebe.Nombre.replace(
                    /[^A-Za-z]/g,
                    ""
                );
            }
    ...
    computed: {
        ...
        isFormValid() {
            ...
            if (this.selectedAgeStatus === "born") {
                ...
                return (
                    nombreValido && apellidosValidos && sexoValido && edadValida
                );
            }
        },
