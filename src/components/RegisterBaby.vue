<template>
  <div class="container-register">
    ...
    <form @submit.prevent="registrarBebe" class="login form-register">
      <div class="flex flex-register input-container width-50">
        <div class="input-container width-50 ic1">
          <input v-model="DatosBebe.Nombre" @input="validarNombre" maxlength="15" id="firstname" class="input" type="text"
            placeholder="" />
          <div class="cut"></div>
      ...
      <div class="input-container age-btn-container width-50 text-center">
        <div @click="ChangeStatusAge" :class="{
      ...
      <div v-else class="input-container width-50">
        ...
        <select v-model="DatosBebe.Edad" class="input select-age">
          <option v-for="semana in semanasEmbarazo" :key="semana" :value="semana">
            Semana {{ semana }}
          </option>
        </select>
      </div>
      <div class="input-container width-50 ic1 text-center">
        <button :disabled="!isFormValid" :class="isFormValid
    ...
    <svg class="img-cloud-bg" xmlns="http://www.w3.org/2000/svg" width="1374" height="753" viewBox="0 0 1374 753"
      fill="none">
      <path
      ...
      <defs>
        <linearGradient id="paint0_linear_173_151" x1="1302" y1="256.039" x2="286.227" y2="654.061"
