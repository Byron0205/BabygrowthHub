    ...
    <div class="container-nombre-expediente">
        ...
        <div class="containterCalendar">
            ...
            <div v-if="ismobileView" class="selectedDayEvents">
                <h3 class="titleEventsMobile">
                    Eventos del día {{ formatDate(selectedDate) }}
                </h3>
                <button
                    class="btnTaskMobile"
                    @click="isNewEventPopupOpen = true"
                >
                ...
                <ul>
                    <li
                        ...
                        :key="event.IDActividad"
                        class="selectedDayEvent"
                        :style="{ backgroundColor: event.CategoriaColor }"
                    >
                        <div class="selectedDayEventInfo">
                            <div class="selectedDayEventTitle">
                                {{ event.Titulo }}
                            </div>
                        </div>
                        <button class="btnTaskMobile" @click="viewEvent(event)">
                            Ver detalles
                        </button>
                    </li>
                </ul>
            ...
            <div class="createEventContainer" v-if="isNewEventPopupOpen">
                <div class="createEventContent">
                    ...
                    <div class="formCreateNewEvent">
                        ...
                        <div class="newEventFlexContainer">
                            <label class="newEventLabel" for="newEventDate"
                                >Fecha</label
                            >
                            <input
                                class="newEventInput"
                        ...
                        <div class="newEventFlexContainer row">
                            <button class="newEventBnt save" @click="saveEvent">
                                Guardar
                            </button>
                            <button
        ...
        <div class="eventDetailsContainer" v-if="selectedEvent">
            <div class="eventDetailsContent">
                ...
                <div style="margin-top: 1rem">
                    <div
                        class="eventDetailsFlexContainer centerElements informationTop"
                    >
                        <p class="eventDetailsTitle">
                ...
                >
                    ...
                    <p class="eventDetailsDescription">
                ...
                <div class="eventDetailsButtonsContainer">
                    <button
                        ...
                        @click="
                            deleteEvent(
                                selectedEvent.IDActividad,
                                selectedEvent.IDBebe
                            )
                        "
                    >
                    ...
                    <button
                        class="eventDetailsButton cancel"
    ...
    methods: {
        ...
        selectDate(day) {
            if (day.date) {
                ...
                this.selectedDayEvents = this.getEventsForDate(
                    this.selectedDate
                ); // Asignar los eventos del día seleccionado
        ...
        getActivities() {
            axios
                .get(
                    `http://localhost:3000/recuperar-actividades/${this.IDAdulto}`
                )
                .then((response) => {
                    this.events = response.data;
                    this.events = this.events.filter(
                        (event) => event.IDBebe === this.selectedSon
                    );
        ...
        getBabies() {
            axios
                .get(`http://localhost:3000/recuperar-bebes/${this.IDAdulto}`)
                .then((response) => {
