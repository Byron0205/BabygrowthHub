        ...
        <div class="flexItem">
            <div class="formQuestionsContainer">
                <div class="inputContainer">
                    ...
                    <div class="cut"></div>
                    <label class="placeholderQuestion"
                        >Escribe una pregunta</label
                    >
                </div>
                <br />
                <div>
                    <button class="btnAskQuestion" @click="askQuestion">
                        PREGUNTAR
                    </button>
                </div>
                <br />
...
export default {
    ...
    methods: {
        ...
        askQuestion() {
            ...
            axios
                .post("http://localhost:3000/preguntar-chat", questionData)
                .then((response) => {
                    ...
                    if (msg.response) {
                        ...
                        this.message =
                            "Ha ocurrido un error al procesar la pregunta!";
