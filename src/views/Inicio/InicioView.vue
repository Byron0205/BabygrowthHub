<template>
    <p class="user-name">
        ¡Bienvenido de nuevo,
        <span class="name">{{ nombreUsuario.split(" ")[0] }}</span
        >!
    </p>
    <div class="container-inicio">
        <div>
            <h1 class="stats-title">
                Estadísticas según la edad de los tesoros <br />
                {{ promedios[edadActual].edad }} años
            </h1>
            <div class="cards-container">
                <div class="card-dream">
                    <i
                        class="fa-regular fa-moon custom-icon"
                        style="color: #796cd0"
                    ></i>
                    <h2>
                        <strong>{{ promedios[edadActual].horasSueno }}</strong>
                    </h2>
                    <p>Promedio de horas de dulce descanso</p>
                </div>
                <div class="card-height">
                    <i
                        class="fa-solid fa-ruler-vertical custom-icon"
                        style="color: #fcb510"
                    ></i>
                ...
                <div class="card-weight">
                    ...
                    />
                    <i
                        class="fa-solid fa-weight-scale custom-icon"
                        style="color: #69dcff"
                    ></i>
            ...
            <div class="text-card">
                <p>
                    Cuidar del <strong>sueño, peso y altura</strong> de nuestros
                    bebés es un tesoro invaluable. Con amor y atención, trazamos
                    su camino hacia un crecimiento saludable y lleno de
                    felicidad. ¡Registremos juntos cada paso de este maravilloso
                    viaje hacia un futuro radiante!
                </p>
            </div>
        </div>
...
export default {
    ...
    mounted() {
        ...
        this.notificationShow =
            localStorage.getItem("notification") == "false" ? false : true;
        this.updateData();
    ...
    methods: {
            ...
            if ("Notification" in window) {
                ...
                Notification.requestPermission().then(function (permission) {
                    if (permission === "granted") {
                        ...
                        console.log(
                            "El usuario no ha decidido aún sobre el permiso para mostrar notificaciones."
                        );
                    }
                });
            } else {
        ...
        getActivities() {
            ...
            axios
                .get(`https://localhost/recuperar-actividades/${this.IDAdulto}`)
                .then((response) => {
