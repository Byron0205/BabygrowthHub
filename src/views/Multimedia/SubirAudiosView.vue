<template>
    <div class="container">
        <div class="info-container">
            <img src="https://baby-growth-hub.s3.amazonaws.com/ImagenesSitioWeb/ImagenAudio.png" class="img-multimedia"
                alt="">
            <p class="info-text-audio">Disfruta de la magia que se despliega al compartir y guardar <strong>tus audios más
                    preciados. </strong>
                Cada nota, risa o canción se convertirá en una memoria atesorada para toda la vida,
                que podrás compartir con tus seres queridos y disfrutar una y otra vez.</p>
        </div>
        <div class="form-multi-audio">
            ...
            <div class="select-container">
                <div class="select-wrapper">
                    ...
                    <select class="type-multi-audio" @change="onAlbumChange" v-model="selectedAlbum">
            ...
            <button class="save-multi-audio" @click="uploadFileToServer">Guardar recuerdo</button>
        </div>
    </div>
</template>
