<template>
    <div class="container">
        <div class="info-container">
            ...
            />
            <p class="info-text">
                Sumérgete en un mundo encantador donde las imágenes y videos se
                convierten en tesoros de los momentos más preciosos del
                crecimiento de tus adorables bebés. Comparte en este apartado
                tus <strong>imagenes y videos</strong> más preciados de tus
                tesoros!
            </p>
        </div>
        <div class="form-multi">
            ...
            >
                ...
                <p v-if="uploadedFile" class="drag-text">
                    {{ uploadedFile.name }}
                </p>
                <p v-else class="drag-text">
                    Arrastre imagen (jpg, png), video (mp4) o audio (mp3) o haga
                    clic para elegir archivo.
                </p>
                <i
                    v-if="uploadedFile"
            ...
            <button class="save-multi" @click="uploadFileToServer">
                Guardar recuerdo
            </button>
        </div>
    </div>
